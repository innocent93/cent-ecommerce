...
export const PERMISSIONS = Object.freeze({
  ...
  // Marketplace (Option B) — approving/suspending seller accounts.
...
// and (Option B) approving sellers and triggering their payouts — but
// can't create or manage other staff accounts.
