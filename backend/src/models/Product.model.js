...
const productSchema = new mongoose.Schema(
  {
    ...
    // Optional: unset means the platform itself is the seller (Option A
    // behavior, unchanged). Set means this product belongs to a marketplace
    // seller — see MARKETPLACE_MIGRATION.md. Products created before this
    // field existed simply have it unset, which is why every seller-scoped
