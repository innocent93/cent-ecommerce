...
- **Load testing**: nothing in this document is a substitute for actually load-testing your specific deployment (k6, Artillery, or Locust against a staging environment) before you trust it under real traffic. Numbers in this doc are architectural reasoning, not a benchmark result — I don't have a way to run a real load test against your specific infrastructure from here.
